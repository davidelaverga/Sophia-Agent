...
Current hard gate (2026-09-07): all four components run f809d43daa26a20aa7e32e4b510f3f558918b17e, tree1557667c7acea9feab5cd34680891c872a37ae6b, mem00.v1/epoch1. Fresh three-fixture hosted contract passes and both probe subjects are zero. EI115–118 extraction/review/Pool repairs have deployed product evidence on preceding candidates. EI119 environment resolution is proven in an actual joined f809d43 LangSmith trace. EI120 now exposes an authenticated serving-process snapshot via existing recap export, but explicitly partial metrics are not complete release-counter observation windows. P01D ordinary lifecycle/cleanup is joined and its restarted facade admits zero; cross-candidate evidence cannot count as a complete immutable canary. Full mixed-state consumer/fault matrix, project-wide unknown certification-marker inventory, voice/cache/derivative cleanup and remaining Section17 proof are outstanding. Five complete clean production canaries: **zero**. See `repair-deployment-f809d43.json`. Historical voice debt is waived as a memory deployment blocker, not called clean. No real-user import, ambiguous purge, provider/configuration change or merge has been performed.
