...
const COREVIEW_SAFE_TOOL_EXECUTION_KEYS = new Set([
  ...
  'sessionArtifactIndexEnabled',
  'sessionArtifactIndexRestoreCount',
  'sessionArtifactIndexArtifactCount',
  'sessionArtifactIndexActiveArtifactPresent',
  'sessionArtifactIndexRegisterSource',
  'sessionArtifactIndexDedupedCount',
  'sessionArtifactTrayVisible',
  'sessionArtifactTrayArtifactCount',
  'sessionArtifactOpenAttempted',
  'sessionArtifactOpenResult',
  'sessionArtifactOpenRendererKind',
  'sessionArtifactVersionCount',
  'sessionArtifactVoiceCommandResult',
  'rawArtifactContentExcluded',
  ...
  'htmlBridgeReady',
  'htmlSectionIndexReady',
  'htmlSectionIndexEntryCount',
  'htmlSectionIndexBuildResult',
  'htmlNavigationControllerActive',
  'htmlNavigationRouterUsed',
  'html_navigation_controller_active',
  'htmlNavigationControllerActive',
  'html_navigation_router_used',
  'htmlNavigationCommandKind',
  'html_navigation_command_kind',
  'htmlNavigationTargetSafe',
  'html_navigation_target_safe',
  'htmlNavigationTargetKind',
  'html_navigation_target_kind',
  'htmlNavigationResult',
  'html_navigation_result',
  'htmlNavigationFailureReason',
  'html_navigation_failure_reason',
  'htmlNavigationScrollTopBefore',
  'html_navigation_scroll_top_before',
  'htmlNavigationScrollTopAfter',
  'html_navigation_scroll_top_after',
  'htmlNavigationScrolled',
  'html_navigation_scrolled',
  'htmlNavigationCommandId',
  'html_navigation_command_id',
  'htmlNavigationTimedOut',
  'html_navigation_timed_out',
  'htmlNavigationWaitedForReady',
  'html_navigation_waited_for_ready',
  'htmlNavigationFeedbackEmitted',
  'html_navigation_feedback_emitted',
  'htmlNavigationPreventedPdfFallback',
  'html_navigation_prevented_pdf_fallback',
  'htmlNavigationBlockedGenericToolCount',
  'html_navigation_blocked_generic_tool_count',
  'htmlInternalNavigationUsedSameResolver',
  'html_internal_navigation_used_same_resolver',
  'htmlVoiceNavigationUsedSameResolver',
  'html_voice_navigation_used_same_resolver',
  'htmlNavigationSuppressedEmitArtifact',
  'html_navigation_suppressed_emit_artifact',
  'htmlNavigationSuppressedBuilderTool',
  'html_navigation_suppressed_builder_tool',
  'htmlNavigationResultConfirmedBeforeFeedback',
  'html_navigation_result_confirmed_before_feedback',
...
function buildCoreviewStillFrameDiagnosticsSummary(coreview: CoreviewUsageTelemetry): Record<string, unknown> {
  return {
    ...
    sessionArtifactIndexEnabled: coreview.visual.sessionArtifactIndexEnabled,
    sessionArtifactIndexRestoreCount: coreview.visual.sessionArtifactIndexRestoreCount,
    sessionArtifactIndexArtifactCount: coreview.visual.sessionArtifactIndexArtifactCount,
    sessionArtifactIndexActiveArtifactPresent: coreview.visual.sessionArtifactIndexActiveArtifactPresent,
    sessionArtifactIndexRegisterSource: coreview.visual.sessionArtifactIndexRegisterSource,
    sessionArtifactIndexDedupedCount: coreview.visual.sessionArtifactIndexDedupedCount,
    sessionArtifactTrayVisible: coreview.visual.sessionArtifactTrayVisible,
    sessionArtifactTrayArtifactCount: coreview.visual.sessionArtifactTrayArtifactCount,
    sessionArtifactOpenAttempted: coreview.visual.sessionArtifactOpenAttempted,
    sessionArtifactOpenResult: coreview.visual.sessionArtifactOpenResult,
    sessionArtifactOpenRendererKind: coreview.visual.sessionArtifactOpenRendererKind,
    sessionArtifactVersionCount: coreview.visual.sessionArtifactVersionCount,
    sessionArtifactVoiceCommandResult: coreview.visual.sessionArtifactVoiceCommandResult,
    rawArtifactContentExcluded: coreview.visual.rawArtifactContentExcluded,
    ...
    htmlBridgeReady: coreview.visual.htmlBridgeReady,
    htmlSectionIndexReady: coreview.visual.htmlSectionIndexReady,
    htmlSectionIndexEntryCount: coreview.visual.htmlSectionIndexEntryCount,
    htmlSectionIndexBuildResult: coreview.visual.htmlSectionIndexBuildResult,
    htmlNavigationControllerActive: coreview.visual.htmlNavigationControllerActive,
    htmlNavigationRouterUsed: coreview.visual.htmlNavigationRouterUsed,
    htmlNavigationCommandKind: coreview.visual.htmlNavigationCommandKind,
    htmlNavigationTargetSafe: coreview.visual.htmlNavigationTargetSafe,
    htmlNavigationTargetKind: coreview.visual.htmlNavigationTargetKind,
    htmlNavigationResult: coreview.visual.htmlNavigationResult,
    htmlNavigationFailureReason: coreview.visual.htmlNavigationFailureReason,
    htmlNavigationScrollTopBefore: coreview.visual.htmlNavigationScrollTopBefore,
    htmlNavigationScrollTopAfter: coreview.visual.htmlNavigationScrollTopAfter,
    htmlNavigationScrolled: coreview.visual.htmlNavigationScrolled,
    htmlNavigationCommandId: coreview.visual.htmlNavigationCommandId,
    htmlNavigationTimedOut: coreview.visual.htmlNavigationTimedOut,
    htmlNavigationWaitedForReady: coreview.visual.htmlNavigationWaitedForReady,
    htmlNavigationFeedbackEmitted: coreview.visual.htmlNavigationFeedbackEmitted,
    htmlNavigationPreventedPdfFallback: coreview.visual.htmlNavigationPreventedPdfFallback,
    htmlNavigationBlockedGenericToolCount: coreview.visual.htmlNavigationBlockedGenericToolCount,
    htmlInternalNavigationUsedSameResolver: coreview.visual.htmlInternalNavigationUsedSameResolver,
    htmlVoiceNavigationUsedSameResolver: coreview.visual.htmlVoiceNavigationUsedSameResolver,
    htmlNavigationSuppressedEmitArtifact: coreview.visual.htmlNavigationSuppressedEmitArtifact,
    htmlNavigationSuppressedBuilderTool: coreview.visual.htmlNavigationSuppressedBuilderTool,
    htmlNavigationResultConfirmedBeforeFeedback: coreview.visual.htmlNavigationResultConfirmedBeforeFeedback,
