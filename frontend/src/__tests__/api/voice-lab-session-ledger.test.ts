...
const database = vi.hoisted(() => {
  ...
  const preflight = {
    ...
    cleanupFunctions: [
      ...
      ['sophia_voice_lab_cleanup_write_fence', '', 'plpgsql', 'v', true, ['search_path=pg_catalog, public, pg_temp'], false, '0678607736ee21130257e2a87f79bc807d12a0f6d22295f55079ff6bbb4aa1b2'],
