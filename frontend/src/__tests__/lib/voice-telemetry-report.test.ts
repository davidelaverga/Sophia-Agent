  ...
  return {
    ...
    coreview: {
      visual: {
        ...
        builderWorkspaceEventCount: 2,
        builderLastWorkspaceEventType: 'builder.update_requested',
        ...
        coreviewBuilderUpdateIntentDetected: true,
        coreviewBuilderUpdateAttempted: true,
        coreviewBuilderUpdateResult: 'update_requested',
        coreviewBuilderUpdateBlockedReason: null,
        coreviewBuilderUpdateMode: 'revise_version',
        coreviewBuilderUpdateArtifactContextPresent: true,
