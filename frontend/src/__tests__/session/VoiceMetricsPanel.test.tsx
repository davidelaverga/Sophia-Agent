...
const geminiTelemetry: VoiceRuntimeTelemetry = {
  ...
  langsmithTraceId: 'trace-gemini-session-dev',
  ...
  outputAudioReceivedCount: 1,
  outputAudioPlaybackScheduledCount: 1,
  outputAudioPlaybackStartedCount: 1,
  outputAudioPlaybackCompletedCount: 0,
  outputAudioPlaybackFlushedCount: 1,
  outputAudioPlaybackDroppedCount: 0,
