...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SOPHIA_COREVIEW_ENABLED: z.string().optional(),
    NEXT_PUBLIC_SOPHIA_COREVIEW_STILL_FRAME_ENABLED: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SOPHIA_COREVIEW_ENABLED: process.env.NEXT_PUBLIC_SOPHIA_COREVIEW_ENABLED,
    NEXT_PUBLIC_SOPHIA_COREVIEW_STILL_FRAME_ENABLED: process.env.NEXT_PUBLIC_SOPHIA_COREVIEW_STILL_FRAME_ENABLED,
