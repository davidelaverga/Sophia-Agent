...
def test_spreadsheet_about_presentation_topic_resolves_to_tabular_not_pptx():
    # Codex P2 (2026-06-30): a spreadsheet/tabular request whose only "presentation"
    # mention is topical must resolve to xlsx/csv, not grab the deck toolchain
    # (the broad PPTX branch matches "create ... presentation" before xlsx/csv).
    cases = {
        "create an Excel spreadsheet about presentation design": "xlsx",
        "make a spreadsheet about slide-deck metrics": "xlsx",
        "generate a CSV about presentation engagement": "csv",
    }
