...
def _file_target_directive_block(target_path: str, task_type: str | None) -> str:
    ...
    if target_ext == "pptx":
        return (
            ...
            "for the normal DeerFlow visual deck path unless the user explicitly "
            "asked for a plain/text-only/no-visual deck. If image generation fails, "
            "continue with a valid chart/text PPTX and record the fallback honestly.\n"
