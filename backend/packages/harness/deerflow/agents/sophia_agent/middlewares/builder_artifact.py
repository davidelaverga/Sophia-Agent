...
_PRESENTATION_AUTHORING_SYSTEM_PROMPT = (
    ...
    "left, top, width, and height; keep it at least 48x24px and wholly inside the canvas. No other CSS selector "
    "matching an anchor may declare a nonzero margin or any logical or vendor margin property; reset margins on "
