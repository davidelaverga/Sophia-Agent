...
_PRESENTATION_AUTHORING_SYSTEM_PROMPT = (
    ...
    "overrides. Keep the shared stylesheet under 8 KiB, target each html_body under 4 KiB, and keep "
    "combined html_body bytes within 4 KiB times the slide count; slides may borrow unused body "
    "budget, with each slide capped at the hard 6 KiB ceiling. Keep each slide_css under 1 KiB, the creative plan "
