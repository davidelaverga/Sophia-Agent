...
_PRESENTATION_AUTHORING_SYSTEM_PROMPT = (
    ...
    "narrative text must be at least 24px; compact optional labels and captions may use 20-23px; no "
    "visible text may be below 20px. Cut copy instead of shrinking type. Give every text box vertical "
    "slack beyond its computed line height so PowerPoint metrics cannot clip the last line. Align peer "
    "shapes and connector bars to exact shared edges or centerlines. "
