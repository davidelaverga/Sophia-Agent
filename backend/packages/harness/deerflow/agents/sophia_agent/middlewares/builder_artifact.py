...
_PRESENTATION_AUTHORING_SYSTEM_PROMPT = (
    ...
    "geometry out of slide_css and inline styles: a declared anchor's style attribute must not contain position, "
    "box-sizing, margin, left, top, width, or height. Do not use !important, right, bottom, inset, min/max sizing, "
