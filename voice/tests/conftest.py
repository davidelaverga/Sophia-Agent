...
def make_settings(**overrides: object) -> VoiceSettings:
    values = {
        ...
        "adaptive_silence_short_ms": 600,
        "adaptive_silence_medium_ms": 800,
        "adaptive_silence_long_ms": 1200,
        "adaptive_silence_ceiling_ms": 1400,
        "adaptive_silence_continuation_bonus_ms": 300,
        "adaptive_silence_fragment_bonus_ms": 500,
