...
4. Create useful slide assets, not a slide-image album:
   - use chart/data skills or `generate_visual_asset` for numeric charts;
   - use `generate_excalidraw_diagram` for process, architecture, system,
     concept, sequence, timeline, or comparison diagrams;
   - use `image-generation/scripts/generate.py` for optional hero/section
     imagery or illustrative scenes when it improves the deck.
